...
try:
	while True:
		...
		c += '| {0: >2.1f} | {1: >3.1f} | {2:.1f} | {3:.1f} | {4: >3d} | {5:0>3d} | {6:.2f} | {7:.2f} | {8:.1f} | {9:.1f} | {10:.3f} | {11:.3f} | {12:.0f} | {13:.0f} |'.format(charge_voltage_limit, charge_current_limit, discharge_current_limit, discharge_voltage_limit, state_of_charge, state_of_health, state_of_charge_hi_res, battery_voltage, battery_current, battery_temperature, min_cell_voltage, max_cell_voltage, min_temperature, max_temperature)
		print('\r {} '.format(c))
